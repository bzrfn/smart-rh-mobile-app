...
export default function VerifyLoginCodeScreen({ navigation, route }: Props) {
  ...
  async function resendCode() {
    Alert.alert(
      'Reenviar código',
      'Para reenviar el código, vuelve al login e ingresa nuevamente tus credenciales.',
      [
          ...
          <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.heroCard}>
              <View style={styles.heroTopRow}>
                ...
                <View style={styles.heroBadge}>
                  <Text style={styles.heroBadgeText}>2FA</Text>
                </View>
              </View>

              <Text style={styles.eyebrow}>Acceso seguro</Text>
              <Text style={styles.heroTitle}>Verifica tu inicio de sesión</Text>
              <Text style={styles.heroSubtitle}>
                Enviamos un código de un solo uso a:
              </Text>
            ...
            <View style={styles.card}>
              ...
              <Pressable onPress={resendCode}>
                <Text style={styles.secondaryAction}>Reenviar código</Text>
              </Pressable>

              <Pressable onPress={() => navigation.navigate('Login')}>
                <Text style={styles.mutedAction}>Volver al login</Text>
              </Pressable>
            </View>
          </ScrollView>
        </TouchableWithoutFeedback>
